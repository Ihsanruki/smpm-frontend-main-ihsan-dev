    ...
    <Page title={'Merchant'}>  
      ...
      <PageContent>  
        ...
        >  
          ...
          >  
            <FormInput name="No. Job Order" label="No. Job Order" required />  
            <FormInput name="Merk EDC" label="Merk EDC" required />  

            <FormInput name="Jenis Job Order" label="Jenis Job Order" required /> 
            <FormInput name="Tipe EDC" label="Tipe EDC" required /> 
            <FormInput name="Nama Vendor" label="Nama Vendor" required /> 
            <FormInput name="Tanggal Perjanjian Kerja Sama " label="Tanggal Perjanjian Kerja Sama" required /> 
