...
import { getAuditTrails } from '@smpm/services/systemlogsService';  
import { IAuditTrail } from "@smpm/models/systemlogsModel";  
...
const dummyData: IAuditTrail[] = [  
  {  
    ...
    ActionName: 'View',  
    MenuName: 'Dashboard',  
    DataBefore: '{"key": "oldValue"}',  
    DataAfter: '{"key": "newValue"}',  
    UserName: 'johndoe',  
    IpAddress: '192.168.1.100',  
    ActivityDate: '2023-04-20 10:30:00',  
    Browser: 'Chrome',  
    OS: 'Windows 10',  
    AppSource: 'Web',  
    created_by: 1,  
    updated_by: 1,  
    created_at: '2023-04-20 10:30:00',  
    updated_at: '2023-04-20 10:30:00',  
    deleted_at: null,  
  },  
  {  
    id: 2,  
    ...
    ActivityDate: '2023-04-21 14:45:00',  
    Browser: 'Firefox',  
    OS: 'macOS',  
    AppSource: 'Mobile',  
    created_by: 1,  
    updated_by: 1,  
    created_at: '2023-04-21 14:45:00',  
    updated_at: '2023-04-21 14:45:00',  
    deleted_at: null,  
  },  
];  
